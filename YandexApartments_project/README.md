...
- Файл YandexApartments_project содержит проект без комментариев ревьювера.
- Файл YandexApartments_project_withRewiew содержит проект с комментариями ревьювера.
